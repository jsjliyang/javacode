...
public class Countries {
  ...
  public static void main(String[] args) {
    printl(capitals(10));
    printl(names(10));
    printl(new HashMap<String,String>(capitals(3)));
    printl(new LinkedHashMap<String,String>(capitals(3)));
    printl(new TreeMap<String,String>(capitals(3)));
    printl(new Hashtable<String,String>(capitals(3)));
    printl(new HashSet<String>(names(6)));
    printl(new LinkedHashSet<String>(names(6)));
    printl(new TreeSet<String>(names(6)));
    printl(new ArrayList<String>(names(6)));
    printl(new LinkedList<String>(names(6)));
    printl(capitals().get("BRAZIL"));
  }
} /* Output:
